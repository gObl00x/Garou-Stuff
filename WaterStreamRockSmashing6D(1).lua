local WSRS = game:GetObjects("rbxassetid://0x3603754d7")[1].garou["Water Stream Rock Smashing"].Script
...
local fallback = WSRS.Animations:FindFirstChildOfClass('KeyframeSequence')
